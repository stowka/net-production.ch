								...
								<li class="4u polaroid">
									<a 	
										...
										foreach ($projects as $project): 
											...
											echo "<li class=\"li-project\" ><a class=\"fancybox\" rel=\"group-" . $type->getId() . "\" href=\"global/img/screenshots/mini/" . str_replace("png", "jpg", str_replace(" ", "%20", $project->getPicture())) . "\" target=\"_blank\"><div class=\"img-project square animated\" >",
